...
const EXAMPLE_DATA: MyTableItem[] = [
  {id: 1, name: 'American Champion'},
  {id: 2, name: 'American Champion'},
  {id: 3, name: 'American Spirit'},
  {id: 4, name: 'A Shortfall of Gravitas'},
  {id: 5, name: 'Betty R Gambarella'},
  {id: 6, name: 'Elsbeth III'},
  {id: 7, name: 'GO Ms Chief'},
  {id: 8, name: 'GO Ms Tree'},
];
